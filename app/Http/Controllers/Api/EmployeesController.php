...
class EmployeesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $customMessages = [
            ...
            'job_title_category_id.required' => 'The job title category ID field is required.',
            'job_title_category_id.integer' => 'The job title category ID must be an integer.',
            'job_title_category_id.exists' => 'The selected job title category ID does not exist in the database.',
