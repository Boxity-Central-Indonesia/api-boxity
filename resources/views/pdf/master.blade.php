@if (!function_exists('getCompanyName') || !function_exists('getCompanyAddress') || !function_exists('getCompanyPhone') || !function_exists('getCompanyEmail'))
...
<body>
    ...
    <hr>
    <h6 class="align-center my-4" style="text-transform: uppercase;">@yield('title')</h2>
    @yield('content')
    <footer class="my-5">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 text-left">
                    &copy;PT. Boxity Central Indonesia
                </div>
            </div>
        </div>
    </footer>
